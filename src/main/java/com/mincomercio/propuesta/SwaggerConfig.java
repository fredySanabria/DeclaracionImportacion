package com.mincomercio.propuesta;
...
public class SwaggerConfig {
    ...
    public static final ApiInfo DEFAULT = new ApiInfo("Desarrollo enfocado al dominio",
            "Prueba Declaracion de importacion", "1.0", "urn:tos",
            DEFAULT_CONTACT,
